...
struct MlxRefreshRateHelper {
  static bool call(Adafruit_MLX90640 &sensor, mlx90640_refreshrate rate) {
...
template <>
struct MlxRefreshRateHelper<bool> {
  static bool call(Adafruit_MLX90640 &sensor, mlx90640_refreshrate rate) {
    return sensor.setRefreshRate(rate);
  }
};

static bool setRefreshRateCompat(Adafruit_MLX90640 &sensor, mlx90640_refreshrate rate) {
  return MlxRefreshRateHelper<decltype(sensor.setRefreshRate(rate))>::call(sensor, rate);
}
